...
public class RCC_CreateAudioSource : MonoBehaviour {
	...
	/// </summary>
	public static AudioSource NewAudioSource(GameObject go, string audioName, float minDistance, float maxDistance, float volume, AudioClip audioClip,
		bool loop, bool playNow, bool destroyAfterFinished, AudioMixerGroup mixer = null){
