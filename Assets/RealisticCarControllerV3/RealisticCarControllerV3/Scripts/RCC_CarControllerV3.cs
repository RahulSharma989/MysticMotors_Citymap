...
public class RCC_CarControllerV3 : MonoBehaviour
{
    ...
    private bool _shouldInverse = false;

    public bool shouldInverse
    {
        set { _shouldInverse = value; }
        get { return _shouldInverse; }
    }
...
/*    RCCSettings.behaviorType = RCC_Settings.BehaviorType.Racing;
*/
    ...
    public bool canGoReverseNow = false;
    ...
    public float engineTorque = 3500f; // Default Engine Torque.
    public float brakeTorque = 2000f; // Maximum Brake Torque.,
    public float minEngineRPM = 2500f; // Minimum Engine RPM.
    ...
    public float highspeedsteerAngle = 20f; // Maximum Steer Angle At Highest Speed.
    ...
    [Range(0f, 0.5f)] public float gearShiftingDelay = 0.5f;
    [Range(.5f, .95f)] public float gearShiftingThreshold = .5f;
    [Range(.1f, .9f)] public float clutchInertia = .1f;
    ...
    [Range(0f, 1f)] public float minEngineSoundPitch = 0f;
    [Range(1f, 2f)] public float maxEngineSoundPitch = 3f;
    [Range(0f, 1f)] public float minEngineSoundVolume = 0f;
    ...
    [HideInInspector] public float boostInput = 100f;
    ...
    public AudioSource airCrossing;
...
/*        if (GetComponent<RCC_AICarController>())
        ...
        switch (RCCSettings.behaviorType)
        {
            ...
            case RCC_Settings.BehaviorType.Drift:
                ...
                ESP = false;
                TCS = false;
                highspeedsteerAngle = Mathf.Clamp(highspeedsteerAngle, 20f, 25f);
    ...
    void SoundsInitialize()
    {
        ...
        switch (audioType)
        {
            ...
            case AudioType.OneSource:
                ...
                engineSoundHigh = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                // airCrossing = Helper.FindChild (this.gameObject, "AirCrossing").GetComponent<AudioSource> ();
                // supportingSound = Helper.FindChild (this.gameObject, "SupportingSound").GetComponent<AudioSource> ();

                if (autoCreateEngineOffSounds)
                {

                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                ...
                else
                {
                    ...
                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false, audioMixer);
            ...
            case AudioType.TwoSource:
                ...
                engineSoundHigh = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                engineSoundLow = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low AudioSource", 5, 25, 0, engineClipLow, true, true, false, audioMixer);

                if (autoCreateEngineOffSounds)
                {

                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                    engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLow, true, true, false, audioMixer);
                ...
                else
                {
                    ...
                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false, audioMixer);
                    engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLowOff, true, true, false, audioMixer);
            ...
            case AudioType.ThreeSource:
                ...
                engineSoundHigh = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                engineSoundMed = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Medium AudioSource", 5, 50, 0, engineClipMed, true, true, false, audioMixer);
                engineSoundLow = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low AudioSource", 5, 25, 0, engineClipLow, true, true, false, audioMixer);
                ...
                if (autoCreateEngineOffSounds)
                {
                    ...
                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false, audioMixer);
                    engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Medium Off AudioSource", 5, 50, 0, engineClipMed, true, true, false, audioMixer);
                    engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLow, true, true, false, audioMixer);
                ...
                else
                {
                    ...
                    engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false, audioMixer);
                    engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Medium Off AudioSource", 5, 50, 0, engineClipMedOff, true, true, false, audioMixer);
                    engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLowOff, true, true, false, audioMixer);
        ...
        engineSoundIdle = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Idle AudioSource", 5, 25, 0, engineClipIdle, true, true, false, audioMixer);
        reversingSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "Reverse Sound AudioSource", 1, 10, 0, reversingClip, true, false, false, audioMixer);
        windSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "Wind Sound AudioSource", 1, 10, 0, windClip, true, true, false, audioMixer);
        brakeSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "Brake Sound AudioSource", 1, 10, 0, brakeClip, true, true, false, audioMixer);

        if (useNOS)
            NOSSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "NOS Sound AudioSource", 5, 10, 1f, NOSClip, true, false, false, audioMixer);
        if (useNOS || useTurbo)
            blowSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "NOS Blow", 1, 10, 1, null, false, false, false, audioMixer);
        if (useTurbo)
        {
            turboSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "Turbo Sound AudioSource", .1f, .5f, 0, turboClip, true, true, false, audioMixer);
    ...
    {
        //PowerUpsHandler.instance.StartEngine();
    ...
    public void KillEngine()
    {
        ...
        fuelInput = 0f;
        engineRunning = false;
       // PowerUpsHandler.instance.KillEngine();
    ...
    void Update()
    {
        /*        if (this.gameObject.CompareTag("Player")) {
                    Debug.Log("SteerInput of the player" + steerInput);
                }*/
      /*  if (this.gameObject.CompareTag("Enemy"))
        {
            SetEnemyProperties();
       ...
       /* if (GetComponent<VehicleNitro>().NOS)
        {
            gasInput = 1;
    ...
    private void CheckForNOS()
    {
        if (Input.GetButton("Fire3"))// && !this.gameObject.CompareTag("Enemy"))
        {
            engineTorque = 15000;
            minEngineRPM = 15000;
            maxEngineRPM = 20000;
    ...
    private void CheckForDrift()
    {
        ...
        {
            highspeedsteerAngle = 35f;
            _isDrift = true;
        }
        if (Input.GetKeyUp(KeyCode.Space))
        {
            highspeedsteerAngle = 15f;
        }
    }
    public void DrifDown()
    {
        highspeedsteerAngle = 35f;
        foreach(RCC_WheelCollider wheel in allWheelColliders)
        {
            wheel._shouldSkid = true;
        }
        _isDrift = true;
    }
    public void DriftUp()
    {
        foreach (RCC_WheelCollider wheel in allWheelColliders)
        {
            wheel._shouldSkid = false;
        }
        highspeedsteerAngle = 15f;
    }
/*    public void Inverse(bool _shouldInverse)
    {
        if (_shouldInverse)
        {
            Debug.Log("Assigning negative SteerInput " + steerInput);
            steerInput = -Input.GetAxis(RCCSettings.horizontalInput);
        }
        else
        {
            Debug.Log("Assigning Positive SteerInput " + steerInput);
            steerInput = Input.GetAxis(RCCSettings.horizontalInput);
        }
    } */
    ...
    public void Inputs()
    {
        ...
        switch (RCCSettings.controllerType)
        {
            ...
            case RCC_Settings.ControllerType.Keyboard:
                ...
                try
                {
                   // brakeInput = RampJumpManager._instance.GetBrakeInput() ? 0 : Mathf.Clamp01(-Input.GetAxis(RCCSettings.verticalInput));
                }
                ...
                if (_shouldInverse && !_isAi)
                {
                    steerInput = -Input.GetAxis(RCCSettings.horizontalInput);
                }
                else if(!_shouldInverse && !_isAi)
                {
                    steerInput = Input.GetAxis(RCCSettings.horizontalInput);
                }
    ...
    void FixedUpdate()
    {
        ...
        if (rigid.velocity.magnitude < .01f && Mathf.Abs(_steerInput) < .01f && Mathf.Abs(_gasInput) < .01f && Mathf.Abs(rigid.angularVelocity.magnitude) < .01f)//&& !GetComponent<VehicleNitro>().isNiroPlaying)
            isSleeping = true;
        else
            isSleeping = false;
    ...
    void Engine()
    {
        ...
        rawEngineRPM = Mathf.Clamp(Mathf.MoveTowards(rawEngineRPM, (maxEngineRPM * 1.1f) *
            (Mathf.Clamp01(Mathf.Lerp(0f, 1f, (1f - clutchInput) *
                ...
                (((_gasInput) * clutchInput) + idleInput))), engineInertia * 100f), 0f, maxEngineRPM * 1.1f);
    ...
    public void EngineSounds()
    {
        ...
        // pitchLevel = Mathf.Lerp (airCrossing.pitch, Mathf.Lerp (minEngineSoundPitch, maxEngineSoundPitch, engineRPM / 7000f), Time.fixedDeltaTime * 50f);
        // pitchLevel = Mathf.Lerp (supportingSound.pitch, Mathf.Lerp (minEngineSoundPitch, maxEngineSoundPitch, engineRPM / 7000f), Time.fixedDeltaTime * 50f);*/

        // Define RPM ranges for low, medium, and high RPM sounds.
        float lowRPMRange = maxEngineRPM * 0.25f;
        float medRPMRange = maxEngineRPM * 0.5f;

        

        // Calculate the low, medium, and high RPM levels.
        if (engineRPM < lowRPMRange)
        {
            lowRPM = Mathf.InverseLerp(0f, lowRPMRange, engineRPM);
            medRPM = 0f;
            highRPM = 0f;
        }
        else if (engineRPM < medRPMRange)
        {
            lowRPM = Mathf.InverseLerp(lowRPMRange, medRPMRange, engineRPM);
            medRPM = Mathf.InverseLerp(0f, medRPMRange - lowRPMRange, engineRPM - lowRPMRange);
            highRPM = 0f;
        }
        else
        {
            lowRPM = 0f;
            medRPM = Mathf.InverseLerp(medRPMRange, maxEngineRPM, engineRPM);
            highRPM = Mathf.InverseLerp(0f, maxEngineRPM - medRPMRange, engineRPM - medRPMRange);
        }

        // Adjust the sound volumes using the levels calculated above.
        lowRPM = Mathf.Clamp01(lowRPM) * maxEngineSoundVolume;
        medRPM = Mathf.Clamp01(medRPM) * maxEngineSoundVolume;
        highRPM = Mathf.Clamp01(highRPM) * maxEngineSoundVolume;

        // Calculate volume level based on gas input.
        float volumeLevel = Mathf.Clamp(_gasInput, 0f, 1f);

        // Calculate pitch level based on RPM.
        ...
        switch (audioType)
        {
            ...
            case RCC_CarControllerV3.AudioType.OneSource:
                ...
                // airCrossing.volume = volumeLevel * maxEngineSoundVolume;
                // airCrossing.pitch = pitchLevel;

                // supportingSound.volume = volumeLevel * maxEngineSoundVolume;
                // supportingSound.pitch = pitchLevel;

                engineSoundHighOff.volume = (1f - volumeLevel) * maxEngineSoundVolume;
                engineSoundHighOff.pitch = pitchLevel;

                if (engineSoundHigh.enabled && !engineSoundHigh.isPlaying)
                    engineSoundHigh.Play();
                // if (!airCrossing.isPlaying)
                // 	airCrossing.Play ();
                // if (!supportingSound.isPlaying)
                // 	supportingSound.Play ();
        ...
        if (engineSoundIdle)
        {
            ...
            engineSoundIdle.volume = Mathf.Lerp(0f, maxEngineSoundVolume, engineRPM / maxEngineRPM);
    ...
    void GearBox()
    {
        ...
        if (brakeInput >= 0.8f && direction == 1 && gasInput < 0 && gasInput > -1)
            rigid.drag = 0.8f; //was 2
    ...
    public IEnumerator ChangeGear(int gear)
    {
        ...
        if (gear == -1)
        {
            if (gasInput == -1 && _brakeInput == 1)
                rigid.drag = 0f;
            currentGear = 1;
            //maxEngineRPM = 300000f;
            if (!NGear)
                direction = -1;
            else
                direction = 0;
    ...
    private void Turbo()
    {
        ...
        turboBoost = Mathf.Lerp(turboBoost, Mathf.Clamp(Mathf.Pow(_gasInput, 10) * 100f + Mathf.Pow(engineRPM / maxEngineRPM, 500) * 200f, 0f, 30f), Time.fixedDeltaTime * 10f);
    ...
    private void ResetCar()
    {
        ...
        if (speed < 5 && !rigid.isKinematic)
        {
            ...
            //Changes for car stuck with wall
            if(transform.eulerAngles.x < 330 && transform.eulerAngles.x > 290)
            {
                resetTimeX += Time.deltaTime;
                if (resetTimeX > 5)
                { //was 3
                    Debug.Log("respawn");
                    transform.rotation = Quaternion.Euler(0f, transform.eulerAngles.y, 0f);
    ...
    public void Uncontrollable()
    {
        if (_isAi)
        {
            StartCoroutine(GetUncontrollable());
        }
    }

    IEnumerator GetUncontrollable()
    {
        steerInput = 1;
